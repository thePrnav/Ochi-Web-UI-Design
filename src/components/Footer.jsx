...
function Footer() {
  return (
    <div className='flex gap-[9vw]  w-full h-screen bg-zinc-900 p-12'>
        ...
        <div className='w-1/2 '>
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-10 tracking-tighter'>Presentations</h1>
